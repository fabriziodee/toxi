...
let handler = async(m, { conn, text }) => {
    ...
    if (text.length > 300) throw 'Sorry The Text Too Long, You Can Only Use 300 Text!'
    ...
    m.reply('*✅️ Problem has been reported to Owner Bot, fake report/main2 will not be responded too!*')
}
